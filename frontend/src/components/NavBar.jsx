        ...
        <div className="flex flex-col items-start p-4 space-y-4 w-full h-full">
          ...
          {isLoggedIn ? (
            ...
            <button
              ...
              className="text-gray-800 hover:text-blue-600 px-3 py-2 rounded-md text-md font-bold"
            >
              Login
            </button>
          )}
          <Link
            to="/about"
            onClick={toggleMenu}
            className="text-gray-800 hover:text-blue-600 px-3 py-2  rounded-md text-sm font-bold"
          >
            About
          </Link>
        </div>
